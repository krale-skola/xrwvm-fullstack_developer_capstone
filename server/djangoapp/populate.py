...
def initiate():
    ...
    car_model_data = [
      ...
      "colors": "Yellow", "car_make": car_make_instances[0]},

      {"name": "XTRAIL", "type": "SUV", "year": 2023,
      "colors":"Orange", "car_make": car_make_instances[0]},

      {"name": "A-Class", "type": "SUV", "year": 2023,
      "colors": "Grey", "car_make": car_make_instances[1]},

      {"name": "C-Class", "type": "SUV", "year": 2023,
      "colors": "White", "car_make": car_make_instances[1]},

      {"name": "E-Class", "type": "SUV", "year": 2023,
      "colors": "red", "car_make": car_make_instances[1]},

      {"name": "A4", "type": "SUV", "year": 2023,
      "colors": "Blue", "car_make": car_make_instances[2]},

      {"name": "A5", "type": "SUV", "year": 2023,
      "colors": "Blue", "car_make": car_make_instances[2]},

      {"name": "A6", "type": "SUV", "year": 2023,
      "colors": "Black", "car_make": car_make_instances[2]},

      {"name": "Sorrento", "type": "SUV", "year": 2023,
      "colors": "White", "car_make": car_make_instances[3]},

      {"name": "Carnival", "type": "SUV", "year": 2023,
      "colors": "White", "car_make": car_make_instances[3]},

      {"name": "Cerato", "type": "Sedan", "year": 2023,
      "colors": "Blue", "car_make": car_make_instances[3]},

      {"name": "Corolla", "type": "Sedan", "year": 2023,
      "car_make": car_make_instances[4]},

      {"name": "Camry", "type": "Sedan", "year": 2023,
      "colors": "Orange", "car_make": car_make_instances[4]},

      {"name": "Kluger", "type": "SUV", "year": 2023,
      "colors": "Grey", "car_make": car_make_instances[4]},
